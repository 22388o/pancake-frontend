        ...
        <StyledCard mr={[null, null, null, null, '24px']} mb={['24px', null, null, null, '0']}>
          ...
          <CardBody p="0 24px 24px">
            ...
            <FoldableText title={t('Step 4: After the auction')} mt="24px">
              ...
              <Text color="textSubtle">
                {t(
                  'If your bid was successful, your farm will begin at the specified time. The BGSP you bid will not be returned to you and will be added to our weekly BGSP burn.',
                )}
              </Text>
              <Text color="textSubtle">
